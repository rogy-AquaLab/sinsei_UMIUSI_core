...
class Joystick(Node):
    def __init__(self):
        ...
        self._orientation_publisher = self.create_publisher(Vector3, "/cmd/target_orientation", 10)
        self._velocity_publisher = self.create_publisher(Vector3, "/cmd/target_velocity", 10)
        self._indicator_led_publisher = self.create_publisher(Bool, "/cmd/indicator_led_enabled", 10)
